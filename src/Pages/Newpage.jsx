    ...
    <div className="w-full h-screen flex items-center justify-center bg-gray-100">
      <div className="text-center max-w-xl px-4">
        ...
        <p className="text-gray-600 mb-8">
          We would love to connect with you to know more about your brand and
          your goals. <br />
          <br />
          Kindly fill the form below for us to get some insights on your
          requirements and plan a meeting accordingly.
        </p>
