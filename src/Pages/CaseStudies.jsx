    ...
    <div>
      ...
      <div className="flex items-center justify-center font-[sans-serif]">
        <div className="w-[1248px] text-center">
          <p className="md:text-3xl font-semibold text-light-gray md:mt-10 capitalize text-2xl">
            case studies
          </p>
          <h1 className="md:text-5xl font-bold text-purple mt-10 text-2xl">
            {heading}
          </h1>
          <p className="md:text-2xl font-normal text-light-blue mt-10 mb-10 text-xl">
            {subheading}
          </p>
        </div>
      </div>
