    ...
    <div className="w-full h-[116px] font-sans relative z-50">
      <div className='flex items-center justify-between mt-6 px-4 sm:px-8 md:px-16 lg:px-24'>
        ...
        <div className="hidden lg:flex justify-center">
          <div className="h-[55px] w-[45vw] border-2 rounded-[3rem] flex items-center justify-between px-4 lg:px-6 text-sm md:text-base font-medium text-purple border-light-purple">
            <Link to="/Shopify-Store-Build" className="px-3 py-2 rounded-full hover:bg-light-purple transition duration-300">Shopify Store Build</Link>
            <Link to="/Landing-Page-Design" className="px-3 py-2 rounded-full hover:bg-light-purple transition duration-300">Landing Page Design</Link>
            <Link to="/Case-Studies" className="px-3 py-2 rounded-full hover:bg-light-purple transition duration-300">Case Studies</Link>
          </div>
        </div>
      ...
      {isOpen && (
        <div className='absolute top-full left-0 w-full bg-white shadow-md flex flex-col items-center p-4 gap-4 z-50'>
          <Link to="/Shopify-Store-Build" className="w-full text-center py-2 rounded-full hover:bg-purple hover:text-white transition duration-300" onClick={() => setIsOpen(false)}>Shopify Store Build</Link>
          <Link to="/Landing-Page-Design" className="w-full text-center py-2 rounded-full hover:bg-purple hover:text-white transition duration-300" onClick={() => setIsOpen(false)}>Landing Page Design</Link>
          <Link to="/Case-Studies" className="w-full text-center py-2 rounded-full hover:bg-purple hover:text-white transition duration-300" onClick={() => setIsOpen(false)}>Case Studies</Link>
          <button
            onClick={() => {
              navigate("/Newpage");
              setIsOpen(false);
